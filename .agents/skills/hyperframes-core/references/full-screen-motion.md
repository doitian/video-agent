...
- **Verify intentional overflow with snapshots.** Before adding `data-layout-allow-overflow` to silence an inspect warning, run `bunx hyperframes snapshot` and confirm the overflow is what you want.
