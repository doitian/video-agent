...
- The project was scaffolded with `bunx hyperframes init --tailwind`.
...
bunx hyperframes render . --workers 1 --quality draft --output tailwind-proof.mp4
```
...
1. Project scaffolded with `bunx hyperframes init --tailwind`?
...
7. Re-run `bunx hyperframes check`, then the render proof above.
