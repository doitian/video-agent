...
```bash
bunx hyperframes tts script.txt --voice af_heart --output narration.wav
bunx hyperframes transcribe narration.wav --model small.en   # voice af_heart is American English
```
