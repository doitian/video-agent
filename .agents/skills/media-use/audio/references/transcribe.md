...
```bash
bunx hyperframes transcribe audio.mp3  --model small.en             # known English
bunx hyperframes transcribe video.mp4  --model small --language es  # known Spanish
bunx hyperframes transcribe audio.mp3  --model small                # unknown language (auto-detect)
bunx hyperframes transcribe subtitles.srt                           # import existing
bunx hyperframes transcribe subtitles.vtt
bunx hyperframes transcribe openai-response.json
```
