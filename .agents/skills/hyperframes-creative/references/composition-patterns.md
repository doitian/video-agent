...
Put a headline _behind_ a presenter so their silhouette occludes the text. Requires a transparent cutout produced by `bunx hyperframes remove-background presenter.mp4 -o presenter.webm`.
