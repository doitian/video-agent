...
**Shader transitions** — 14 built-in WebGL GPU effects. Install with `bunx hyperframes add <name>` (block name ≠ shader name — see `skills/hyperframes-registry/references/discovery.md`); full API in `packages/shader-transitions/README.md`.
